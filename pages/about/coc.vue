<template>
  <main>
    <page-banner title="Code of Conduct" />
    <section class="section">
      <div class="container">
        <div>
          <p>HKOSCon is a community conference intended for networking and collaboration in the developer and user community.</p>
          <p>We value the participation of each member of the Open Source community and want all attendees to have an enjoyable and fulfilling experience. Accordingly, all attendees are expected to show respect and courtesy to other attendees throughout the conference and at all conference events, whether officially sponsored by HKOSCon or not.</p>
          <p>To make clear what is expected, all delegates/attendees, speakers, exhibitors, organizers and volunteers at any HKOSCon event are required to conform to the following Code of Conduct. Organizers will enforce this code throughout the event.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        ...
        <p>HKOSCon is dedicated to providing a harassment-free conference experience for everyone, regardless of gender, sexual orientation, disability, physical appearance, body size, race, or religion. We do not tolerate harassment of conference participants in any form.</p>
        ...
        <p>Be kind to others. Do not insult or put down other attendees. Behave professionally. Remember that harassment and sexist, racist, or exclusionary jokes are not appropriate for HKOSCon.</p>
    ...
    <section class="section">
      <div class="container">
        ...
        <p>Be careful in the words that you choose. Remember that sexist, racist, and other exclusionary jokes can be offensive to those around you. Excessive swearing and offensive jokes are not appropriate for HKOSCon.</p>
