...
module.exports = {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Hong Kong Open Source Conference is the biggest annual open source event in Hong Kong. Hong Kong Open Source Conference 2020 is going to held on 12 - 13 Jun, 2020 (Fri - Sat)' },
  ...
  */
  ...
  env: {
    ...
    EVENT_INFO_URL: process.env.EVENT_INFO_URL || 'https://hkoscon.org/2020/data/event_info.json',
